...
<div id="local">
   <div class="caminho">Onde Estou: Eliel Imóveis &raquo; Painel de Controle</div><!--caminho-->
...
$edit_imoveis = 'UPDATE eliel_imoveis SET imovelTitulo = :imovelTitulo, imovelNegocio = :imovelNegocio, imovelTipo = :imovelTipo, 
...
<?php
 ...
 $sql_pegaAtivos = 'SELECT * FROM eliel_imoveis WHERE imovelStatus = :imovelStatus AND imovelTermino >= :data
 ...
 try{
	 ...
	 foreach($resultado_pegaAtivos as $resAtivos){
		...
		$dataFim = mktime(0,0,0,date('m',strtotime($editFinal)),date('d',strtotime($editFinal)),                   date('Y',strtotime($editFinal)));
...
<span class="exibir"><img src="../midias/<?php echo $editThumb;?>" alt="" width="100"/></span> 
    ...
    <form name="anuncios_aprovar" action="" enctype="multipart/form-data" method="post">
      ...
      <label>
        ...
        <input type="text" name="editTitulo" value="<?php echo $editTitulo;?>" size="100" />
      </label>
      ...
      <label>
        <span>Descrição:</span>
        <textarea name="editDesc" cols="100" rows="5"><?php echo $editDesc;?></textarea>
      </label>
   ...
   <tr>
    ...
    <label>
      ...
      <label>
        ...
        <input type="text" name="editFacilidades" value="<?php echo $editFacilidades;?>" size="100" />
      </label>
...
<table width="100%" border="0" cellspacing="2" cellpadding="0">
  <tr>
    ...
    <label>
        <span>Rua:</span>
        <input type="text" name="editRua" value="<?php echo $editRua;?>" size="50" />
      </label>
    </td>
    <td>
    <label>
        <span>Número:</span>
        <input type="text" name="editNumero" value="<?php echo $editNumero;?>" size="50" />
      </label>
    </td>
  </tr>
  <tr>
    ...
    <label>
        <span>Bairro:</span>
        <input type="text" name="editBairro" value="<?php echo $editBairro;?>" size="50" />
      </label>
    </td>
    <td>
    <label>
        <span>Próximo:</span>
        <input type="text" name="editProximo" value="<?php echo $editProximo;?>" size="50" />
      </label>
...
$sql_deletaImg = 'DELETE FROM  eliel_midias WHERE fotoId = :fotoId';
try{
...
<?php
$sql_pegaImagem = 'SELECT * FROM eliel_midias WHERE imovelId = :imovelId';
try{
