...
<div id="local">
   <div class="caminho">Onde Estou: Eliel Imóveis &raquo; Painel de Controle &raquo; Ativos</div><!--caminho-->
...
$sql_termina = 'UPDATE eliel_imoveis SET imovelTermino = :imovelTermino WHERE imovelId = :imovelId';
...
<?php include_once("sistema/carregando.php");?>
 ...
 ?> 
  ...
  <tr <?php echo $cor;?>>
    ...
    <td align="center"><a href="painel.php?exe=admin-imoveis/edit&id=<?php echo $anuncioId;?>">Editar</a></td>
  </tr>
