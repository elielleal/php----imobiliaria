...
$sql_enderecoImovel = 'UPDATE eliel_imoveis SET imovelRua = :imovelRua, imovelNumero = :imovelNumero, 
...
$imovelId = $_POST['imovelId'];
$sql_limitaUpload = 'SELECT * FROM eliel_midias WHERE imovelId = :imovelId';
try{
...
for($i=0;$i<$contarImg;$i++){
	...
	if(!empty($imagemNome) && in_array($imagemTipo, $imgPermitido)){
	   ...
	   $sql_cadastraImagem  = 'INSERT INTO eliel_midias (imovelId, imovelImg) ';
