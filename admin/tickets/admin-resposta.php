...
<div id="local">
   <div class="caminho">Onde Estou: Eliel Imóveis &raquo; Painel de Controle &raquo; Suporte</div><!--caminho-->
...
$sqlTicket  = 'UPDATE eliel_ticket SET ticketResposta = :ticketResposta WHERE ticketId = :ticketId';
...
try{
	...
	echo '<div class="ok">Resposta enviada com sucesso</div>';
...
$pegaTicket = 'SELECT * FROM eliel_ticket WHERE ticketId = :ticketId';
try{
...
?>
   ...
   <form name="ticket" action="" enctype="multipart/form-data" method="post">
     <textarea rows="5" cols="100" name="ticket"></textarea>
