...
<div id="local">
   <div class="caminho">Onde Estou: Eliel Imóveis &raquo; Painel de Controle &raquo; Editar cliente</div><!--caminho-->
...
$sql_atualizaPefil = 'UPDATE eliel_clientes SET nome = :clienteNome, senha = :clienteSenha, telefone =                      :clienteTelefone WHERE clienteId = :clienteId';
...
<?php
    ...
    $sql_pegaCliente = 'SELECT * FROM eliel_clientes WHERE clienteId = :clienteId';
