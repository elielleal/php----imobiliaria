...
<div id="local">
   <div class="caminho">Onde Estou: Eliel Imóveis &raquo; Painel de Controle &raquo; Clientes</div><!--caminho-->
...
<?php
    ...
    $sql_pegaCliente = 'SELECT * FROM eliel_clientes WHERE usuarioNivel = :usuarioNivel';
