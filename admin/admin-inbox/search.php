...
<?php include_once("header.php")?>
    ...
    <div id="local">
   <div class="caminho">Onde Estou: Eliel Imóveis &raquo; Painel de Controle &raquo; Admin de perfil &raquo; Mensagens do Site
   </div><!--caminho-->
...
$sql_inboxAdmin = 'SELECT * FROM eliel_mailadmin WHERE emailNome LIKE :emailStatus ORDER BY emailData ASC';
