...
$sendAssunto = 'Respostas Freitas Imóveis';
$sendStatus = 'completo';
...
$sql_sendMails = 'UPDATE eliel_mailcliente SET emailResTxt = :emailResTxt, emailStatus = :emailStatus WHERE emailId = :emailId';
...
<?php include_once("sistema/carregando.php");?>
 ...
 <table width="100%" border="0" cellspacing="3" cellpadding="0">
  ...
  $emailId = $_GET['mail'];
  $sql_mailCliente = 'SELECT * FROM eliel_mailcliente WHERE clienteId = :clienteId AND emailId =  :emailId ORDER BY emailData ASC';
