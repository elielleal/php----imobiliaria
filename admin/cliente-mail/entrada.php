...
<?php include_once("sistema/carregando.php");?>
 ...
 <table width="100%" border="0" cellspacing="3" cellpadding="0">
  ...
  $sql_mailCliente = 'SELECT * FROM eliel_mailcliente WHERE clienteId = :clienteId AND emailStatus =  :emailStatus ORDER BY emailData ASC';
  ...
  <tr <?php echo $cor;?>>
    ...
    <td align="center"><a href="painel.php?exe=cliente-mail/resposta&mail=<?php echo $emailId;?>">Visualizar/Responder</a></td>
  </tr>
  <?php
	  }
  ?>
