...
<?php include_once("header.php")?>
    ...
    <div id="local">
   <div class="caminho">Onde Estou: Eliel Imóveis &raquo; Painel de Controle &raquo; Clientes
   </div><!--caminho-->
...
$sql_aguardando = 'UPDATE eliel_imoveis SET imovelStatus = :imovelStatus, imovelConfirma = :imovelConfirma
...
try{
	...
	echo '<div class="ok">Recebemos sua confirmação. assim que validada seu imóvel será anúnciado e poderá ser visto em seus imóveis ativos! por enquanto será visualizado em Aguardando aprovação!</div>';
	  ...
	  echo 'Erro ao atualizar imóvel'.$error_aguardando->getMessage();
       ...
       <?php include_once("sistema/carregando.php");?>
		 ...
		 <h2>Bem vindo ao painel de anúncios da Freitas Imóveis aqui você pode criar e gerenciar seus anúncios!</h2>
   ...
   <p>Qualquer duvida fique a vontade para entrar em contato pelo e:mail hugovasconcelosf@hotmail.com ou pelo FONE: 31 3457-0415</p>
 ...
 <table width="100%" border="0" cellspacing="3" cellpadding="0">
  <tr style="background:#666; color:#FFF">
    ...
    <td align="center">Informe o pagamento na Tabela</td>
    <td align="center">Pague com o Pagseguro</td>
 ...
 ?> 
  ...
  <tr <?php echo $cor;?>>
    ...
    <td align="center"><!-- INICIO FORMULARIO BOTAO PAGSEGURO -->
...
<div class="no"><strong>Atenção:</strong> Após efetuar pagamento informe no campo a autenticação de seu pagamento!</div>
  ...
  <tr style="background:#f4f4f4;">
   ...
   <strong>Para ativar seu imóvel efetue o depósito de R$9:90 na seguinte conta:</strong><br />
    ...
    <strong>Cliente:</strong> Hugo Vasconcelos<br />
