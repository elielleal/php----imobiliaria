<div id="pagina">
   ...
   <h1>Anuncie</h1>
    ...
    <p>O Sistema de anúncios da Eliel Imóveis e totalmente automatizado. Você se cadastra e terá acesso a um painel de controle como área de membros onde você poderá!</p>
     ...
     <p>Cadastra-se agora e comece a anunciar seu imóvel no maior portal de anúncios imobiliários da web!</p>

     <p><strong>Duvidas? <a href="index.php?pg=contato">Clique aqui!</a></strong></p>
     </div><!--fecha anuncies-->
   
     <form name="cadastra_cliente" id="cadastra_cliente" method="post" action="index.php?pg=anunciar_ok" enctype="multipart/form-data">
