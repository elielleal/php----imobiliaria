<div id="pagina">
   ...
   <h1>Fale Conosco</h1>
    ...
    <p>
    eliel_leal_13@hotmail.com.br<br />
	...
	$sql_verificaContato = 'SELECT emailCod FROM eliel_mailadmin WHERE emailCod = :contatoCod';
	...
	try{
     ...
     echo '<div class="enviado">Por favor aguarde algúns minutos para enviar uma nova mensagem! Obrigado!</div><!--enviado-->';
}else{
	
	$sql_contatoSite  = 'INSERT INTO eliel_mailadmin (emailNome, emailEmail, emailMensagem, emailData, emailStatus, emailCod) ';
	...
	try{
		...
		echo '<div class="enviado">Seu e-mail foi envado com sucesso! Responderemos em breve!</div>';
      ...
      <fieldset><legend>Entre em contato!</legend> 
        ...
        <label>
          <span>Nome:</span>
          <input class="nom" type="text" name="nome" />
        </label>
        ...
        <label>
          <span>Mensagem:</span>
          <textarea class="nom" name="msg" rows="5"></textarea>
        </label>
        
           
          <input type="submit" name="contato_site" value="Fale conosco" class="btn" id="nome" />
